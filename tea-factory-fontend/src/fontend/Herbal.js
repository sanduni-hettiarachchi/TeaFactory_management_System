...
const Herbal = () => {
  ...
  const images = [
    {
      url: "https://townfarmtonics.com/wp-content/uploads/2020/10/enjoying-your-tea-1024x683.jpg",
    },
    {
      url: "https://cdn.shopify.com/s/files/1/0039/7780/5924/files/DSC01279_480x480.jpg?v=1632961123",
    },
    {
      url: "https://tibena.com/wp-content/uploads/2019/02/HerbalInfusions2.jpg",
    },
  ];

  const image = [
    {
      url: "https://skinalchemists.com/cdn/shop/products/20220625_073904.jpg?v=1656147555",
    },
    {
      url: "https://www.medikonda.com/cdn/shop/products/herbal-teas5_1200x.jpg?v=1587718019",
    },
    {
      url: "https://m.media-amazon.com/images/I/71Cj+aS6fOL._UF1000,1000_QL80_.jpg",
    },
  ];
    ...
    <div className="font-sans text-white-800">
      ...
      >
        ...
        <ul className="hidden md:flex space-x-6 text-lg">
          ...
          <li>
            <a href="/herbal" className="hover:text-green-300 underline underline-offset-4 decoration-green-500">
              Herbal Infusion
            </a>
          </li>
          <li>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-700 text-lg">
              <li>🌱 Caffeine-free herbal blends, crafted from flowers, fruits, spices, and aromatic herbs</li>
              <li>🌱 Naturally soothing and refreshing, perfect for relaxation or daily wellness</li>
              <li>🌱 Rich in natural goodness, supporting digestion, immunity, and overall balance</li>
              <li>🌱 Unique flavors & aromas, from calming chamomile to zesty lemongrass and peppermint</li>
              <li>🌱 Brewing tip: Steep 5–7 minutes at 95°C–100°C for a flavorful and rejuvenating cup</li>
