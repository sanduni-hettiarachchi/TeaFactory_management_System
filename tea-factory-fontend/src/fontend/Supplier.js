  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:3001/api/Suplier/add",
        formData,
        {
          headers: {
    ...
    <div className="bg-gray-800 min-h-screen flex flex-col">
      ...
      >
        ...
        <ul className="hidden md:flex space-x-6 text-lg">
          <li>
            <a href="/join" className="hover:text-green-300 px-3 py-1 rounded-md bg-green-700">
              Join Us
            </a>
          </li>
        ...
        <div className="max-w-3xl mx-auto mt-8 mb-12 bg-white p-8 rounded-xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-green-700 hover:bg-green-600 text-white px-6 py-3 rounded-lg font-semibold shadow-md transition duration-300 disabled:opacity-50"
            >
