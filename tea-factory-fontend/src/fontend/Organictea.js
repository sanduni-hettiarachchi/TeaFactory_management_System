...
const Organictea = () => {
  ...
  const images = [
    {
      url: "https://www.uclahealth.org/sites/default/files/styles/landscape_16x9_030000_1200x675/public/images/c4/black-tea-istock-1176.jpg?f=c221b9cc&itok=xufoHSxj",
    },
    {
      url: "https://www.harney.com/cdn/shop/articles/Unharney-fromteatotree-1.jpg?v=1633704045https://www.alveus.eu/wp-content/smush-webp/035-c.jpg.webp",
    },
    {
      url: "https://www.zestaceylontea.com/wp-content/uploads/2020/08/Zesta_Desktop_Banner_1920x700_b10.jpg",
    },
  ];

  const image = [
    {
      url: "https://www.thursonteas.com/wp-content/uploads/2021/05/organic-black-tea-earl-grey-20-envelopes.jpg",
    },
    {
      url: "https://www.thursonteas.com/wp-content/uploads/2021/05/organic-black-tea-english-breakfast-20-envelopes.jpg",
    },
    {
      url: "https://www.thursonteas.com/wp-content/uploads/2021/05/organic-green-tea-mint.jpg",
    },
  ];
    ...
    <div className="font-sans text-white-800">
      ...
      >
        ...
        <ul className="hidden md:flex space-x-6 text-lg">
          ...
          <li>
            <a href="/organictea" className="hover:text-green-300 underline underline-offset-4 decoration-green-500">
              Organic Tea
            </a>
          </li>
          <li>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-700 text-lg">
              <li>🌱 Premium Organic Tea, naturally grown in the highlands of Sri Lanka without synthetic fertilizers or pesticides</li>
              <li>🌱 Hand-picked leaves to ensure freshness, flavor, and superior quality</li>
              <li>🌱 Sustainably cultivated using environmentally friendly farming practices</li>
              <li>🌱 Rich in natural antioxidants, supporting wellness and a healthy lifestyle</li>
              <li>🌱 Brewing tip: Steep 2–3 minutes at 80°C–85°C for a pure, soothing, and refreshing cup</li>
