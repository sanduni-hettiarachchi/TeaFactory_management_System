...
const EmpAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:3001/api/empadd", formDataObj, {
          headers: {
      ...
      <form onSubmit={handleSubmit}>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <select name='martalStatus' onChange={handleChange} placeholder ="Marital Status" className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required>
          ...
          <div>
            ...
            <select name='role' onChange={handleChange} className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required>
              ...
              <option value="employee">Transport Worker</option>
              <option value="employee">Leaf Clerk</option>
              <option value="employee">Factory Dispatch Team</option>
            </select>
          </div>
